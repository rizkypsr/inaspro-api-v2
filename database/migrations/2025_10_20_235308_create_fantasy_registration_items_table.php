...
return new class extends Migration
{
    ...
    public function up(): void
    {
       Schema::create('fantasy_registration_items', function (Blueprint $table) {
            ...
            $table->foreignId('fantasy_tshirt_option_id')->nullable()->constrained('fantasy_tshirt_options')->nullOnDelete()->index();
            $table->foreignId('fantasy_shoe_size_id')->nullable()->constrained('fantasy_shoe_sizes')->nullOnDelete()->index();
